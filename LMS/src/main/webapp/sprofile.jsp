...
<div class="container">
    <div class="profile-container">
        <div class="profile-header">
            <%-- Profile Image --%>
            <img src="/image/${sprofileList[0].email}" width="150" height="150" alt="Profile Photo" class="profile-photo">
            <h2>${sprofileList[0].name}</h2>
            <p>${sprofileList[0].role}</p>
        </div>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered">
                <tbody>
                    <tr>
                        <th>Id</th>
                        <td>${sprofileList[0].id}</td>
                    </tr>
                    <tr>
                        <th>Email</th>
                        <td>${sprofileList[0].email}</td>
                    </tr>
                    <tr>
                        <th>Role</th>
                        <td>${sprofileList[0].role}</td>
                    </tr>
                    <tr>
                        <th>Mobile</th>
                        <td>${sprofileList[0].mobile}</td>
                    </tr>
                    <tr>
                        <th>Password</th>
                        <td>${sprofileList[0].password}</td>
                    </tr>
                </tbody>
            </table>
        </div>
